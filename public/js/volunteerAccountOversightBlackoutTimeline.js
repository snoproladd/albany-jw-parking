/**
 * @fileoverview volunteerAccountOversightBlackoutTimeline.js
 * Mounts the BlackoutTimeline component inside the volunteer account
 * oversight "Blackout Windows" accordion panel.
 *
 * Load is deferred until the accordion first opens to avoid an unnecessary
 * API call when the user never visits that section.
 *
 * @module volunteerAccountOversightBlackoutTimeline
 */
...
document.addEventListener("DOMContentLoaded", () => {
  const container = document.getElementById("bt-oversight");
  if (!container) return;
